...
import type { Profile, VigilState, Session, UsageState } from "../src/types.js";
...

{
  ...
  assert.equal(result.match?.label, "pornhub.com");
  assert.match(result.reason, /Normal/i);
}
...
function startSession(state: VigilState, profileId: string, deviceTargets: Array<"computer" | "phone">, lockLevel: "light" | "deep" = "deep"): void {
