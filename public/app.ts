...
import type { ActivePolicy, DeviceTargetInput, PolicyPhase, Profile, Schedule, VigilState, Session, StateEvent, UnknownRecord, UsageSample } from "../src/types.js";
...
interface DashboardState extends VigilState {
