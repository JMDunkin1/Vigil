...
export function createAccountUi() {
  ...
  function render(): void {
    ...
    setText(
      "#accountModeCopy",
      session.mode === "local"
        ? "This administrator profile owns the local Vigil installation. Hosted accounts can be enabled when the app is deployed."
        : "This account can access the shared Vigil workspace. Administrators can change protection settings."
    );
    setStatus("");
  }
