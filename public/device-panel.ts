...
function renderDevices(devices: DashboardData["devices"], $: QueryElement): void {
  ...
  [
    ...
    ["ManageEngine policy", manageEngine.policyPath || "data/manageengine/sentinel-manageengine-policy.mobileconfig"],
  ...
  $("#iosMdmText").textContent = mdm.note || "Sentinel normally exports profiles for ManageEngine; use this only if replacing ManageEngine with your own APNs-backed MDM server.";
