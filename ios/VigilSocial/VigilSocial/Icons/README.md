...
`../Assets.xcassets`. YouTube and Snapchat use the current 1024×1024 U.S. App
Store artwork (`544007664` and `447188370`) so their companion icons match the
native apps on the Home Screen.
...
the YouTube and Snapchat App Store masters. Then verify Default, Dark, and Tinted appearances
...
The 180×180 `instagram.png`, `youtube.png`, and `snapchat.png` files are retained only for legacy
