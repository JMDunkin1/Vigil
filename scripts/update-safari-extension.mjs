...
for (const name of ['manifest.json', 'reddit-child-lock.js', 'media-child-lock.js', 'youtube-parity.js', 'youtube-limits.js', 'youtube-bridge.js', 'youtube-background.js', 'status.html', 'status.js', 'icons/icon-16.png', 'icons/icon-32.png', 'icons/icon-48.png', 'icons/icon-128.png', 'icons/toolbar.png']) {
