...
assert.match(mainTsSource, /createVigilAppUpdateController/);
...
assert.match(String(scripts["ios:manageengine:apply-enrollment-window"]), /vigil-manageengine-enrollment-window\.mobileconfig/);
...
assert.match(iosRestoreLayoutSource, /VIGIL_SUPERVISOR_KEYBAG/);
...
assert.match(iosUsbApplySource, /Vigil has no active iPhone policy/);
