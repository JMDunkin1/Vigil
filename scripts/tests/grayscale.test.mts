...
import type { DeviceTarget, VigilState, Session } from "../../src/types.js";
...
function startSession(state: VigilState, profileId: string, mode: string, deviceTargets: DeviceTarget[]): void {
