...
try {
  ...
  if (previous.dataDir === undefined) delete process.env.SENTINEL_DATA_DIR;
  else process.env.SENTINEL_DATA_DIR = previous.dataDir;
  if (previous.auth === undefined) delete process.env.SENTINEL_AUTH_ENABLED;
  else process.env.SENTINEL_AUTH_ENABLED = previous.auth;
  if (previous.signups === undefined) delete process.env.SENTINEL_SIGNUPS_ENABLED;
  else process.env.SENTINEL_SIGNUPS_ENABLED = previous.signups;
