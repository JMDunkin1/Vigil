...
chrome.storage.onChanged.addListener((changes, area) => {
  ...
  loadSentinelConnection().then(syncSiteBlockingFromServer);
});
...
async function fetchSentinel(path, options = {}) {
...
async function loadSentinelConnection() {
...
function sentinelUrl(path, localServer) {
