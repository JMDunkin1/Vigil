...
export function keyholderSummary(state) {
...
export function updateKeyholderSettings(state, body = {}, now = new Date()) {
  const current = state.keyholder || {};
...
export function assertKeyholderPasscode(state, passcode) {
  const current = state.keyholder || {};
