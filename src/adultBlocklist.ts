...
const BUILT_IN_EXPLICIT_SOURCE_ID = "sentinel-explicit";
const BUILT_IN_EXPLICIT_SOURCE_LABEL = "Sentinel built-in explicit sites";
...
export async function finalizeAdultBlocklistSnapshot(state: SentinelState): Promise<void> {
...
function availableAdultBlocklistSnapshotsSync(state: SentinelState): AdultBlocklistSnapshot[] {
  const candidates = [
    runtimeSnapshot,
...
function adultBlocklistSnapshotCandidatePaths(state: SentinelState): string[] {
