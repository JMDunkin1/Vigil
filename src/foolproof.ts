...
export function foolproofSummary(state: VigilState, context: FoolproofContext = {}, now = new Date()) {
...
export function assertFoolproofReadyForStrict(state: VigilState, context: FoolproofContext = {}, now = new Date()): void {
...
export function foolproofBlockers(state: VigilState, context: FoolproofContext = {}, now = new Date()): FoolproofBlocker[] {
...
export function extensionVersionReady(state: VigilState) {
...
export function extensionRecentlySeen(state: VigilState, now = new Date()): boolean {
...
export function extensionDynamicRulesReady(state: VigilState, now = new Date()) {
