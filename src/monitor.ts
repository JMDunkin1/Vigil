...
import type { ActivePolicy, MonitorHandle, SentinelState, UnknownRecord, UsageSample, UsageState } from "./types.js";
...
function policyForSample(state: SentinelState, usage: UsageState, sample: UsageSample, now = new Date()): EnforcedPolicy | null {
