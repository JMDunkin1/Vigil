...
export const CONTENT_FILTER_RULES = [
  {
    id: "youtube-shorts",
...
export function contentFilterEnabled(state) {
  return integrityLockdownActive(state) || state.settings?.contentFilterEnabled !== false;
}

export function matchContentFilterUrl(state, value) {
...
export function contentFilterRuleEntries(state, policy) {
