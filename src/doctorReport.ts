...
export function doctorRows(state: SentinelState, context: DoctorContext = {}, now = new Date()): DoctorRow[] {
...
function monitorFromHeartbeat(state: SentinelState, now: Date): SummaryRecord {
