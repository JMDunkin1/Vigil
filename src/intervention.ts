import type { VigilState, StateEvent } from "./types.js";
...
export function interventionSummary(state: VigilState, now = new Date()) {
...
export function emergencyDelaySeconds(state: VigilState, now = new Date()): number {
...
function interventionSettings(state: VigilState): InterventionSettings {
...
function baseEmergencyDelaySeconds(state: VigilState): number {
