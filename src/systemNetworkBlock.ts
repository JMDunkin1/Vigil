...
export function systemNetworkBlockingEnabled(state: SentinelState): boolean {
...
export function browserCompanionRequirement(state: SentinelState, now = new Date()): BrowserCompanionRequirement {
