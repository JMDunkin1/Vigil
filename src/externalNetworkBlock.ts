...
export function externalNetworkBlockEnabled(state: SentinelState): boolean {
  return state.settings?.externalNetworkBlockEnabled === true;
}

export function externalNetworkBlockProvider(state: SentinelState): ExternalNetworkBlockProvider {
...
export function externalNetworkBlockSummary(state: SentinelState): ExternalNetworkBlockSummary {
