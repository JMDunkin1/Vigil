...
import type { SentinelState, UsageBucket, UsageState } from "./types.js";
...
export function focusReport(usage: UsageState, state: SentinelState, now = new Date()) {
...
function dayReport(usage: UsageState, state: SentinelState, date: Date): DayReport {
