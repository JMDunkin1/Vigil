...
export async function buildStatePayload({ state, usage, monitor, activePort, startedAt, localScripts }) {
...
export function publicState(current, policy) {
  return {
...
export function publicIosState(ios = {}) {
  return {
...
export function publicDevicePolicies(current) {
...
export async function buildNetworkPreview(state) {
...
export async function strictPreflightStatus(state, profile, options = {}) {
