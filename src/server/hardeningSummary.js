...
export function hardeningAudit({ state, hosts, firewall, agent, account, protection, monitor, foolproof, stateSeal, sourceSeal }) {
...
export function hardeningActions({ localScriptCommand, resourcePath }) {
  return {
    launchAgentInstall: {
...
export function foolproofDetail(foolproof) {
...
export function launchAgentDetail(agent) {
...
export function hostsDetail(hosts) {
...
export function firewallDetail(firewall) {
...
export function stateSealDetail(stateSeal) {
...
export function sourceSealDetail(sourceSeal) {
...
export function distanceKeyDetail(distanceKey) {
