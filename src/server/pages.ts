...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    @media (prefers-reduced-motion: no-preference) { main::before { animation: sentinel-cross 3s steps(2, end) infinite; } @keyframes sentinel-cross { 50% { color: #fff1b2; transform: translateY(-2px); } } }
  </style>
</head>
<body>
  <main>
...
function pausePageCss() {
  return `
    ...
    * { box-sizing: border-box; }
    ...
    @media (prefers-reduced-motion: no-preference) { main::before { animation: sentinel-cross 3s steps(2, end) infinite; } @keyframes sentinel-cross { 50% { color: #fff0ad; transform: translateY(-2px); } } }
  `;
}
