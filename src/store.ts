...
import type { AppSettings, Profile, Schedule, SentinelState, Session, UsageState } from "./types.js";
...
export async function saveState(state: SentinelState): Promise<void> {
...
export function addEvent(state: SentinelState, type: string, detail: Record<string, unknown> = {}): void {
