...
export function intentReasonPolicy(state: Pick<VigilState, "settings">): { enabled: boolean; minLength: number } {
...
export function intentReasonSummary(state: Pick<VigilState, "settings">) {
...
export function assertIntentReason(state: Pick<VigilState, "settings">, reason: unknown, label = "This action"): string {
