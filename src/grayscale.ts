...
export function grayscaleSummary(state: VigilState, now = new Date()) {
...
export function grayscaleGuardEnabled(state: VigilState, decisionValue: GrayscaleDecision): boolean {
