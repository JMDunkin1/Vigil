...
export function buildIosConfigurationProfile(state, now = new Date()) {
  ...
  const profile = {
    ...
    PayloadDescription: active
      ? "Locks distracting iPhone apps and websites using supervised Apple device-management restrictions generated by Local Screen Time."
      : "Disabled Local Screen Time iPhone policy profile with no app or web restrictions.",
