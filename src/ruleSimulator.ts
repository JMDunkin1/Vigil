...
import type { ActivePolicy, DeviceTarget, LimitBlock, VigilState, UnknownRecord, UsageSample, UsageState } from "./types.js";
...
function strictAppLockBrowserControlPolicy(state: VigilState, now: Date): ActivePolicy | null {
